...
$$
	...
	--
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:00:30+09', 'template1', 'pg_catalog', 'pg_statistic', 1, 0, 28, 28, 100, 129, 404, 0, '811', 64.91, 61.581, 63, 39, 37, 92, 34, 185836, 0, NULL, NULL, '811', NULL, 2, 16, 57.14, 178, '{pg_statistic_relid_att_inh_index}', '{5}', '{0}', '{0}', '{0}', 0.214, 0);
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:00:30+09', 'postgres', 'pg_catalog', 'pg_statistic', 1, 0, 28, 28, 100, 62, 415, 0, '824', 18.81, 37.62, 99, 3, 6, 58, 15, 70274, 0, NULL, NULL, NULL, NULL, 2, 16, 57.14, 178, '{pg_statistic_relid_att_inh_index}', '{5}', '{0}', '{0}', '{0}', 0.086, 0);
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:00:30+09', 'postgres', 'pg_catalog', 'pg_attribute', 1, 0, 88, 51, 57.95, 2, 4678, 0, '825', 122.07, 0, 145, 14, 0, 44, 1, 11696, 0, NULL, NULL, '800', NULL, 2, 3, 3.41, 88, '{pg_attribute_relid_attnam_index,pg_attribute_relid_attnum_index}', '{22,15}', '{0,0}', '{0,0}', '{0,0}', 0.118, 0);
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:01:30+09', 'postgres', 'public', 'pgbench_branches', 0, 0, 1, 1, 100, 113, 10, 0, '11768', 0, 0, 22, 0, 0, 3, 0, 608, 0, NULL, NULL, '11744', NULL, 1, 0, 0, 0, '{}', '{}', '{}', '{}', '{}', 0, 0);
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:01:30+09', 'postgres', 'statsrepo', 'column_20221219', 0, 0, 22, 22, 100, 0, 1225, 0, '11768', 54.825, 82.237, 76, 2, 3, 23, 1, 9683, 0, NULL, NULL, '810', NULL, 1, 0, 0, 0, '{}', '{}', '{}', '{}', '{}', 0.012, 0);
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:02:30+09', 'postgres', 'public', 'pgbench_history', 0, 0, 70, 70, 100, 0, 10920, 0, '11768', 8.351, 16.702, 145, 2, 4, 71, 1, 12515, 0, NULL, NULL, '845', NULL, 1, 0, 0, 0, '{}', '{}', '{}', '{}', '{}', 0.012, 0);
	INSERT INTO statsrepo.autovacuum VALUES ($1, '2012-11-01 00:02:30+09', 'postgres', 'pg_catalog', 'pg_statistic', 1, 0, 33, 33, 100, 21, 583, 0, '27293', 0, 0, 112, 0, 0, 57, 0, 4041, 0, NULL, NULL, NULL, NULL, 2, 16, 48.48, 138, '{pg_statistic_relid_att_inh_index}', '{5}', '{0}', '{0}', '{0}', 0, 0);
